...
<tr><td valign="top" align="center" width="50%">
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture1.png" alt="Workflow Properties" style="width:60%; height:auto;">

</td><td valign="top" align="center" width="50%">

   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture2.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
2. Select Schedule Rule.
   ...
   * Webhooks are self-explanatory.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture4.png" alt="Workflow Properties" style="width:60%; height:auto;">
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture5.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
3. Select Show advanced options.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture6.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
2. For example, find **Handler to get all workflows** under the category **Workflows**.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture7.png" alt="Workflow Properties" style="width:60%; height:auto;">

3. Expand it, click **try it out**, and click **Execute**.

   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture8.png" alt="Workflow Properties" style="width:60%; height:auto;">
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture9.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
1. Search for the **Approval** activity
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture10.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
2. Click and drag the **Request Approval** activity from the Task section onto the Canvas. Drop it right after the **Replace String** activity. 
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture11.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
3. Fill out the required details for the **Approval Title** and **Body Text**.  
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture12.png" alt="Workflow Properties" style="width:60%; height:auto;">
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture13.png" alt="Workflow Properties" style="width:60%; height:auto;">
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture14.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
6. Click the **Display Name** that you assigned to your Approval task and has a status of **Due soon** or select **the Approve** action from the Actions menu on the right.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture16.png" alt="Workflow Properties" style="width:60%; height:auto;">

7. Click **Approve** and navigate to your workflow run (or simply go to your Meraki BOT).

   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture17.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
> The Approve activity just paused the workflow and waited for the approval response. Even if you selected Reject, your workflow would continue to run. You will need to add a Conditional activity after the Approval task in your workflow to check what selection was made by the approver(s) and then design your workflow to take the appropriate actions.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture18.png" alt="Workflow Properties" style="width:60%; height:auto;">
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture19.png" alt="Workflow Properties" style="width:60%; height:auto;">
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture20.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
The Python activity in workflows is your ‘get out of jail free’ card and can be used to do custom data transformations when Workflows doesn’t have the required activity. As of this writing, it is **version: `3.12.3`**. It **includes** libraries like requests, **but not** libraries like paramiko.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture21.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
> In my screenshot below, I can pull out Python variables and use them in future workflow steps, which is extremely handy. The Property Name assigned becomes the name of that variable in the Browse Variable window for the Output of the Python activity.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture23.png" alt="Workflow Properties" style="width:60%; height:auto;">
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture24.png" alt="Workflow Properties" style="width:60%; height:auto;">
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture25.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
1. Drag-and-drop a **JSONPath Query** activity from the Core section of the Activities menu onto the Canvas and place it after the Read Table from JSON that follows the Meraki – Get Organization Devices.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture26.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
2. Open the properties for this JSONPath Query and then use the Browse Variables window to map in the output result of the Meraki – Get Organization Devices activity.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture27.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
4. Enter a descriptive name into the Property Name field so that when we map this value later, we can easily identify the content of the variable.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture28.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
6. Select **Local** for the Scope, **String Array Type** for the Data Type, and a nice Display Name such as Device Serial Number Array.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture29.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
7. Drag a **Set Variables** activity from the Core section of the Activities menu onto the Canvas and place it immediately after the JSONPath Query.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture30.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
8. Click on the Set Variables activity to open up the Properties and in the Variables section, click on Add then in the Variable to update click on the (x) icon to bring up the Browse Variable window. Select the Local variable Device Serial Number Array.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture31.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
9. To set the New Value, use the (x) icon to launch the Browse Variables window and select **Activities &rarr; JSONPath Query &rarr; Jsonpath Queries &rarr; Device Serial Number Array**.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture32.png" alt="Workflow Properties" style="width:60%; height:auto;">
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture33.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
10. Select the **Logic** tab in the left menu and drag a **For Each Loop** onto the Canvas and place it after the **Set Variables** that was just configured.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture34.png" alt="Workflow Properties" style="width:60%; height:auto;">
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture35.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
11. Click the **(x) icon** to access the Browse Variables window and select the **Local Variable Device Serial Number Array**.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture36.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
12. In the activities search box, enter **Meraki – Get Device**, drag that into the **For Each Loop**, and drop it where you see “Drag activity here.”
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture37.png" alt="Workflow Properties" style="width:60%; height:auto;">
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture38.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
Now, how do we get a different serial number for each iteration of the loop? From **Activities &rarr; For Each &rarr; Source Array – Items**. 
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture39.png" alt="Workflow Properties" style="width:60%; height:auto;">
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture40.png" alt="Workflow Properties" style="width:60%; height:auto;">
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture41.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
15. To speed up this lab, delete the activities after the **For Each Loop** and then click **Run**.  
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture42.png" alt="Workflow Properties" style="width:60%; height:auto;">
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture43.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
16. Select **Iteration 6** and then click the **Meraki – Get Device**.  
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture44.png" alt="Workflow Properties" style="width:60%; height:auto;">
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture45.png" alt="Workflow Properties" style="width:60%; height:auto;">
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture46.png" alt="Workflow Properties" style="width:60%; height:auto;">

    Just below the General area you can see the Input that was used.

   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture47.png" alt="Workflow Properties" style="width:60%; height:auto;">
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture48.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
1. Create two new Local variables, one for Network Names and one for Network IDs. Since these are both going to contain multiple entries, they should be of **String Array** Type and Scope **Local**.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture49.png" alt="Workflow Properties" style="width:60%; height:auto;">
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture50.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
2. In the Core section of the Activity menu, click the **JSONPath Query** activity and drag it onto the canvas after the Meraki – Get Organization Networks activity.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture51.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
3. Click the **JSONPath Query** activity to open it’s properties and change the name of the activity to something descriptive, like Network Name and ID JSONPath Query.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture52.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
4. Map the value of the Output – Result from the Meraki – Get Organization Networks into the source JSON to Query field by using the Browse Variables window.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture53.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
6. Click the **Set Variables** activity from the Core section of the Activities menu and drag it onto the canvas placing it directly after the Network Name and ID JSONPath Query.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture54.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
8. Add two variables in the Variables section and map the two local variables into the Variable to Update fields.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture55.png" alt="Workflow Properties" style="width:60%; height:auto;">
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture56.png" alt="Workflow Properties" style="width:60%; height:auto;">

9. Map the corresponding variables from the output of the Network Name and ID JSONPath Query activity.

   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture57.png" alt="Workflow Properties" style="width:60%; height:auto;">
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture58.png" alt="Workflow Properties" style="width:60%; height:auto;">
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture59.png" alt="Workflow Properties" style="width:60%; height:auto;">
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture60.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
10. In the Task section of the Activities menu click and drag the **Create Prompt** activity onto the canvas and place it directly after the Set Network Name and ID arrays activity.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture61.png" alt="Workflow Properties" style="width:60%; height:auto;">

11. Click the **Create Prompt** activity to access its properties window and set a descriptive name like Select Network Name.

   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture62.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
12. Select **Administrator**.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture63.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
13. Create the Prompt Title and provide body text with additional information for the user making the selection. This title will be shown in the list on the Prompts page (accessed via **Automation &rarr; Tasks &rarr; Prompts**).
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture64.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
14. Click the **+Add another form element** in the Add form elements section of the Properties panel.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture65.png" alt="Workflow Properties" style="width:60%; height:auto;">

15. Select the **Dropdown select** option.

   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture66.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
16. Enter **Network Name** in the **Dropdown select label** field and then map the Local variable called Network Names into the **Dropdown select options array**.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture67.png" alt="Workflow Properties" style="width:60%; height:auto;">
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture68.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
17. Click **Run** to test our progress. You’ll now notice that the **Select Network Name** task is blue and remains blue. The workflow has now paused for the User Prompt activity to be completed.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture69.png" alt="Workflow Properties" style="width:60%; height:auto;">

    For the workflow to continue the User Prompt action must be completed.

18. Navigate to **Automation &rarr; User Tasks**.

   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture70.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
20. Click the **Prompt name** to access the Prompt form where the user can select the Network Name and click **Save**. The workflow can now resume running.  
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture73.png" alt="Workflow Properties" style="width:60%; height:auto;">

21. You can return to the View Run for the workflow by clicking the three dots and selecting **View Run**.

   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture74.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
22. Back in the Run Monitoring view of the workflow, click the **Select Network Name** activity and the Properties panel will show the values that were presented in the **Dropdown select** as well as the Prompt Response that shows the Network Name selected by the user.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture75.png" alt="Workflow Properties" style="width:60%; height:auto;">
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture76.png" alt="Workflow Properties" style="width:60%; height:auto;">
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture77.png" alt="Workflow Properties" style="width:60%; height:auto;">
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture78.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
23. From the left-hand Activities menu, in the Python section, click and drag the **Execute Python Script** activity onto the canvas and drop it just below the **Select Network Name** activity.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture79.png" alt="Workflow Properties" style="width:60%; height:auto;">
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture80.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
24. Click the **Execute Python Script** activity to open the Properties panel and give it a descriptive name like Get Network ID from Network Name.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture81.png" alt="Workflow Properties" style="width:60%; height:auto;">
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture82.png" alt="Workflow Properties" style="width:60%; height:auto;">
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture83.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
> The print function is not required, but when used, the output of that will be displayed in the Response Body of the activity.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture84.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
25. The final step is to set the Script Output Variables.  
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture85.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
27. Click the **`(x)`** icon to access the Browse Variables window and map in the value of the Local Variable Network IDs.
   ...
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture86.png" alt="Workflow Properties" style="width:60%; height:auto;">
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture87.png" alt="Workflow Properties" style="width:60%; height:auto;">
   <img src="../../ASSETS/LABS/WORKFLOWS/EXERCISE3/picture88.png" alt="Workflow Properties" style="width:60%; height:auto;">
