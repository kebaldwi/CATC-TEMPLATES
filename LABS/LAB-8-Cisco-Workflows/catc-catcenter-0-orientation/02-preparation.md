...
<img src="../../../ASSETS/LABS/WORKFLOWS/orientation/CreateAccount1.png" alt="Workflow Properties" style="width:50%; height:auto; padding-left:40px;">
...
<td valign="top" align="center" width="50%">
   ...
   <img src="../../../ASSETS/LABS/WORKFLOWS/orientation/CreateAccount2.png" alt="Workflow Properties" style="width:100%; height:auto;">
...
not select Sign in with Cisco SSO.
   ...
   <img src="../../../ASSETS/LABS/WORKFLOWS/orientation/CreateAccount3.png" alt="Workflow Properties" style="width:100%; height:auto;">
...
1. On the left hand menu, select Network and Create a network
   ...
   <img src="../../../ASSETS/LABS/WORKFLOWS/orientation/CreateNetwork1.png" alt="Workflow Properties" style="width:60%; height:auto;">

2. Enter a Network name and click Create network. **Note:** This network will not be used in the lab.

   <img src="../../../ASSETS/LABS/WORKFLOWS/orientation/CreateNetwork2.png" alt="Workflow Properties" style="width:80%; height:auto;">
...
1. Select **`Organization > Early Access`**
   ...
   <img src="../../../ASSETS/LABS/WORKFLOWS/orientation/EnableWorkflows1.png" alt="Workflow Properties" style="width:60%; height:auto;">
...
<img src="../../../ASSETS/LABS/WORKFLOWS/orientation/EnableWorkflows2.png" alt="Workflow Properties" style="width:100%; height:auto;">

</td>
<td valign="bottom" align="center" width="40%">

   <img src="../../../ASSETS/LABS/WORKFLOWS/orientation/EnableWorkflows3.png" alt="Workflow Properties" style="width:80%; height:auto;">
