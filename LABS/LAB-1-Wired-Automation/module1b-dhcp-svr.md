...
![json](../../ASSETS/LABS/WIRED/WindowsDHCPscoperouteronly.png?raw=true "Import JSON")
...
![json](../../ASSETS/LABS/WIRED/DNACDHCPoption43.png?raw=true "Import JSON")
...
![json](../../ASSETS/LABS/WIRED/CC-Discovery-test2-dhcp-ipv4.png?raw=true "Import JSON")
